...
export function FileTypeIcon({ className, path }: FileTypeIconProps): ReactNode {
  return (
    <span className={className} aria-hidden="true">
      <img alt="" draggable={false} src={getFileTypeIconSource(path)} />
    </span>
  )
}
...
export function getFileTypeIconSource(path: string): string {
