...
pub use protocol::{
    ...
    AgentBuiltinCapabilityActivationApproval, AgentBuiltinMcpToolApproval, AgentChatInput,
    AgentChatMessage, AgentChatOutput, AgentCommandArtifactChange, AgentCommandArtifactChangeKind,
    ...
    AgentSkillDependencyStatus, AgentSkillInstallationPreview, AgentSkillInstallationRequest,
