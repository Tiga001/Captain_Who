...
pub use protocol::{
    ...
    AgentInputAttachmentEncoding, AgentInputAttachmentKind, AgentMcpServerScope,
    AgentMcpToolProvenance, AgentOfficeOperationRequest, AgentPatchOperation, AgentPatchPermission,
