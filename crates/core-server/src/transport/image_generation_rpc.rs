...
mod tests {
    ...
    #[test]
    fn configuration_reads_return_only_credential_status() {
        ...
        assert!(initial["result"].get("apiKey").is_none());
        ...
        assert!(configured["result"].get("apiKey").is_none());
        assert_eq!(
            configured["result"]["configuration"]["credentialStatus"],
            "configured"
        );
