...
use mycopilot_core::storage::models::{
    ...
    BrowserDownloadSettingsUpdate, ChatConversationMetaRecord, ChatMessageRecord,
...
use mycopilot_protocol_rs::{
    ...
    STORAGE_LIST_BROWSER_DOWNLOADS_METHOD, STORAGE_LOAD_AGENT_PROMPT_PREFERENCES_METHOD,
    STORAGE_LOAD_ATTACHMENT_IMAGE_METHOD, STORAGE_LOAD_BROWSER_DOWNLOAD_METHOD,
    STORAGE_LOAD_BROWSER_DOWNLOAD_SETTINGS_METHOD, STORAGE_LOAD_COMPOSER_DRAFTS_METHOD,
    ...
    STORAGE_REGISTER_BROWSER_DOWNLOAD_METHOD, STORAGE_SAVE_AGENT_PROMPT_PREFERENCES_METHOD,
    STORAGE_SAVE_BROWSER_DOWNLOAD_SETTINGS_METHOD, STORAGE_SAVE_CHAT_MESSAGE_STATE_METHOD,
