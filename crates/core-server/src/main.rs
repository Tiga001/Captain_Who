...
use mycopilot_protocol_rs::{
    ...
    AgentDetailRequest, AgentFileChangeReadRequest, AgentObserverConversationRequest,
    AgentRejectActionRequest, AgentTemplateCreateRequest, AgentTemplateDeleteRequest,
    AgentTemplateListRequest, AgentTemplateProjectAssignmentRequest,
    ...
    AGENT_GET_FILE_CHANGE_DIFF_METHOD, AGENT_GET_PROVIDER_TRANSITION_STATUS_METHOD,
    ...
    STORAGE_SUMMARIZE_BROWSER_OWNED_DATA_METHOD, STORAGE_UPDATE_BROWSER_HISTORY_METHOD,
