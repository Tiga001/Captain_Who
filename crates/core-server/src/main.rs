...
use mycopilot_protocol_rs::{
    ...
    AgentFileChangeReadRequest, AgentObserverConversationRequest, AgentRejectActionRequest,
    ...
    AgentTemplateUpdateRequest, AgentTreeRequest, CollaborationApprovalDecisionRequest,
    CollaborationApprovalListRequest, CollaborationEventsRequest, CorePingRequest,
