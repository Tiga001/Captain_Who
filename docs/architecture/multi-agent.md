...
当前 canonical storage 是 **v44**。唯一真源：
...
原 canonical v43 在通过旧 fingerprint 验证后，可以单向升级至 v44：原子新增上下文模式偏好与 Run/Wake 模式冻结策略表，旧模式补为 Full，保留已有聊天和协作配置。其他旧版本（含 v34/v35/v36/v37/v38/v39/v40/v41/v42）、catalog fingerprint 不匹配、非空未版本化库或外键违规仍返回 `development_storage_schema_reset_required`。历史文档中的 v7/v8/v10/v11/v17/v19/v20/v22/v23/v24/v25/v26 只是 rollout 阶段标签，不是当前兼容声明；release runner 的 storage step 标为 canonical v44。
...
- [ ] 是否更新 schema v44 后继版本、fingerprint、迁移/reset、双语言 fixture 和 release gate？
