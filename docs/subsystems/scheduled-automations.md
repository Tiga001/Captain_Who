...
SQLite canonical schema 当前为 **v35**；Automation DTO 与 Automation 表记录的 `schemaVersion` 各为 **v1**，permission mode v2，shared Notification contract 为 v1；这些版本域不能混用。Automation 专属三组数据为：
