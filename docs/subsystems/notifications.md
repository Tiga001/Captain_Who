...
1. Notification schema v1、Automation schema v1/permission v2 与 SQLite canonical schema 是不同版本线；数据库版本见[存储与数据生命周期](../architecture/storage-and-data-lifecycle.md)。
